...
packages:
  base: github://Jabe/esphome-zehnder-comfoair-q-can/packages/core/base.yml@v2.7.0
  board: github://Jabe/esphome-zehnder-comfoair-q-can/packages/boards/esp32dev.yml@v2.7.0
  network: github://Jabe/esphome-zehnder-comfoair-q-can/packages/connectivity/ethernet-lan8720.yml@v2.7.0
  comfoair: github://Jabe/esphome-zehnder-comfoair-q-can/packages/comfoair/base.yml@v2.7.0
  sensors: github://Jabe/esphome-zehnder-comfoair-q-can/packages/comfoair/sensors.yml@v2.7.0
  controls: github://Jabe/esphome-zehnder-comfoair-q-can/packages/comfoair/controls.yml@v2.7.0
```
...
- `comfoair/controls.yml` — selects/switch with state sync (fan level, bypass, temperature profile, manual mode, ...) and fan level timer ("Party Timer") buttons
- `comfoair/tuning.yml` — unit setup entities, persisted by the unit (temperature profile mode adaptive/fixed, profile targets, RMOT season limits, fan flow setpoint per level); typically included temporarily
